...
// TerrainLoader2D для визначення типу плитки очікує значення, вказане в коментарі до кожного типу.
...
// та передати шлях до згенерованого файлу в TerrainLoader2D.
