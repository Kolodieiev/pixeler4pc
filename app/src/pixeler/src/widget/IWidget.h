...
namespace pixeler
{
  ...
  public:
     ...
     *
     * @return true - Якщо межа віджета відображається. false - Інакше
     */
     ...
     *
     * @return true - Якщо віджет є прозорим. false - Інакше
     */
     ...
     * @param x Координата точки
     * @param y Координата точки
     * @return IWidget* - Вказівник на вкладений віджет або на самого себе, якщо виявлено пересічення з точкою. nullptr - Інакше
     */
     ...
     * @param x Координата точки
     * @param y Координата точки
     * @return true - Якщо віджет пересікається з вказаною точкою. false - Інакше
     */
     ...
     *
     * @return true - Якщо віджет підтримує дотик. false - Інакше
     */
  ...
  protected:
     ...
     * True - межу буде відмальовано, якщо увімкнено її відображення.
