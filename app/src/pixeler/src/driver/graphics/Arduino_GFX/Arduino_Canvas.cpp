...
void Arduino_Canvas::drawBitmapToFramebufferRotate1(
...
void Arduino_Canvas::drawBitmapToFramebufferRotate2(
    const uint16_t* from_bitmap,
    int16_t bitmap_w,
    int16_t bitmap_h,
    uint16_t* framebuffer,
...
void Arduino_Canvas::drawBitmapToFramebufferRotate3(
    const uint16_t* from_bitmap,
    int16_t bitmap_w,
    int16_t bitmap_h,
    uint16_t* framebuffer,
