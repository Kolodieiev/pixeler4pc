...
Для додавання коду обробки вводу з сенсорного екрана в файлі `pixeler/setup/i2c_setup.h` потрібно вказати піни, до яких підключено шину I2C сенсорного екрана. Далі, в файлі `pixeler/setup/input_setup.h` необхідно розкоментувати визначення `#define TOUCHSCREEN_SUPPORT`, обрати один відповідний драйвер із наявних та налаштувати інші параметри. Після цього для класа `Input` стануть доступні наступні методи:
